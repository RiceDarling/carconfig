...
bool isCoatNormal = false;
    ...
    if(isCoatNormal)
    {
    	//float fresnel =  (dot(reflect(-eye, coatNormal),-eye)*0.2+0.8);
    	resultIBL = /*resultIBL*fresnel+*/ computeIBL_UE4( coatNormal, -eye, albedo, coatRoughness, specular )/**(1.0-fresnel)*/;
    }
